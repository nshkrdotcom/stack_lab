%{
  ...
  profiles: [
    ...
    %{
      ...
      instances: 5,
      required_apps: [],
      owner_groups: [{ExecutionPlane.RemoteFacade.Lane, :lane}],
      env: %{},
      vm_args: ["+S", "1"]
    },
    %{
    ...
    %{
      profile: :ground_plane_projection,
      instances: 1,
      required_apps: [],
      owner_groups: [],
      env: %{},
  ...
  proof: %{
    scenario_ref: "scenario://stack_lab/gn-ten/scale-49-node/v1",
    monolith_baseline_required?: true,
    proof_mode: :opt_in_stress_local,
    host_feasibility_receipt_required?: true
  }
}
