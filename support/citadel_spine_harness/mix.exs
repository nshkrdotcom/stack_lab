  ...
  defp deps do
    [
      ...
      {:citadel_domain_surface,
       path: "../../../citadel/surfaces/citadel_domain_surface", override: true},
      ...
      {:mezzanine_core,
       path: "../../../mezzanine/core/mezzanine_core", runtime: false, override: true},
      {:mezzanine_runtime_profile,
       path: "../../../mezzanine/core/runtime_profile", runtime: false, override: true},
      {:mezzanine_audit_engine,
       path: "../../../mezzanine/core/audit_engine", runtime: false, override: true},
      {:mezzanine_config_registry,
       path: "../../../mezzanine/core/config_registry", runtime: false, override: true},
      {:mezzanine_decision_engine,
       path: "../../../mezzanine/core/decision_engine", runtime: false, override: true},
      {:mezzanine_evidence_engine,
       path: "../../../mezzanine/core/evidence_engine", runtime: false, override: true},
      {:mezzanine_archival_engine,
       path: "../../../mezzanine/core/archival_engine", runtime: false, override: true},
      {:mezzanine_barriers,
       path: "../../../mezzanine/core/barriers", runtime: false, override: true},
      {:mezzanine_lifecycle_engine,
       path: "../../../mezzanine/core/lifecycle_engine", runtime: false, override: true},
      {:mezzanine_object_engine,
       path: "../../../mezzanine/core/object_engine", runtime: false, override: true},
      {:mezzanine_execution_engine,
       path: "../../../mezzanine/core/execution_engine", runtime: false, override: true},
      {:mezzanine_operator_engine,
       path: "../../../mezzanine/core/operator_engine", runtime: false, override: true},
      {:mezzanine_pack_compiler,
       path: "../../../mezzanine/core/pack_compiler", runtime: false, override: true},
      {:mezzanine_pack_model,
       path: "../../../mezzanine/core/pack_model", runtime: false, override: true},
      {:mezzanine_projection_engine,
       path: "../../../mezzanine/core/projection_engine", override: true},
      {:mezzanine_m1_m2_runtime,
       path: "../../../mezzanine/core/m1_m2_runtime", runtime: false, override: true},
      {:mezzanine_runtime_scheduler,
       path: "../../../mezzanine/core/runtime_scheduler", runtime: false, override: true},
      {:mezzanine_source_engine,
       path: "../../../mezzanine/core/source_engine", runtime: false, override: true},
      {:mezzanine_substrate_model,
       path: "../../../mezzanine/core/substrate_model", override: true},
      {:mezzanine_workflow_runtime,
       path: "../../../mezzanine/core/workflow_runtime", runtime: false, override: true},
      {:mezzanine_citadel_bridge,
       path: "../../../mezzanine/bridges/citadel_bridge", override: true},
      {:mezzanine_integration_bridge,
       path: "../../../mezzanine/bridges/integration_bridge", runtime: false, override: true},
      {:mezzanine_leasing,
       path: "../../../mezzanine/core/leasing", runtime: false, override: true},
      ...
      {:ground_plane_contracts,
       path: "../../../ground_plane/core/ground_plane_contracts", runtime: false, override: true},
      {:ground_plane_persistence_policy,
       path: "../../../ground_plane/core/persistence_policy", runtime: false, override: true},
      ...
      {:outer_brain_contracts,
       path: "../../../outer_brain/core/outer_brain_contracts", override: true},
      {:outer_brain_domain_bridge,
       path: "../../../outer_brain/bridges/domain_bridge", override: true},
      {:outer_brain_journal, path: "../../../outer_brain/core/outer_brain_journal"},
      {:outer_brain_memory_contracts,
       path: "../../../outer_brain/core/memory_contracts", override: true},
